...
/**
 * This is a generic transformation function that you might apply within both getOpenPullRequests and getClosedPullRequests
 * @param {string} pullRequests - The GitHub username.
...
async function transformPRData(pullRequests) {
    return pullRequests.map(pullRequests => ({
        title: pullRequests.title,
        url: pullRequests.html_url,
        createdAt: pullRequests.created_at,
